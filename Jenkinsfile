pipeline {
	...
	stage('deploy using ansible') {
	    steps {
		  ansiblePlaybook become: true, credentialsId: 'Ansible-Login', disableHostKeyChecking: true, installation: 'ansible', inventory: '/usr/bin/ansible', playbook: 'deploy.yml'
	    }
	}
    }
}
